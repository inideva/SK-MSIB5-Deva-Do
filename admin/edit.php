            ...
            <div class="card-body">
                <form action="proses_edit.php?=<?php echo $id ?>" id="form-edit" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="file" class="form-control" id="image" name="image" value="<?php echo $gambar ?>">
                    </div>
                    <div class="form-group mb-3">
                        <label class="form-label" for="detail">Detail</label>
                        <input type="text" class="form-control" id="detail" name="detail" value="<?php echo $detail ?>" placeholder="Masukan Detail" required>
                    </div>
                    <div class="form-group mb-3">
                        <label class="form-label" for="harga">Harga</label>
                        <input type="number" class="form-control" id="harga" name="harga" value="<?php echo $harga ?>" placeholder="Masukan Harga" required>
                    </div>
                    <div class="form-group mb-3">
                        <label class="form-label" for="kategori">Kategori</label>
                        <select class="form-control" id="kategori" name="kategori" value="<?php echo $kategori ?>" required>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <select name="stok" id="stok" class="form-control" value="<?php echo $stok ?>">
...
<!-- 
SELECT p.*, k.nama_kategori, w.warna_produk FROM produk as p join tipe_produk as tp on tp.produk_id=p.id join kategori as k on k.id=p.kategori_id join warna as w on w.id=tp.warna_id WHERE id ='$id'" -->